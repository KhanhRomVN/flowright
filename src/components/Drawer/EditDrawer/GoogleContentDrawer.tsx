                ...
                <div className="space-y-4">
                    ...
                    <div className="text-xs text-gray-500 space-y-1">
                        <p className="flex items-center gap-2">
                            <Calendar className="h-4 w-4" /> Created: {new Date(account.createdAt).toLocaleString()}
                        </p>
                        <p className="flex items-center gap-2">
                            <Calendar className="h-4 w-4" /> Updated: {new Date(account.updatedAt).toLocaleString()}
                        </p>
                    </div>
                </div>
            </div>
